...
export const getHookWithFailingPrechecks = async (): Promise<ISafeProtocolHooks> => {
    ...
    return hre.ethers.getContractAt("ISafeProtocolHooks", await hook.getAddress());
};

export const getHookWithPassingPreChecks = async (): Promise<ISafeProtocolHooks> => {
    const hook = await (await hre.ethers.getContractFactory("MockContract")).deploy();
    await hook.givenMethodReturnBool("0x01ffc9a7", true);
    // 0x7359b742 -> selector for preCheckRootAccess
    await hook.givenMethodRevertWithMessage("0x7359b742", "pre-check root access failed");
...
export const getHookWithFailingCallToSupportsInterfaceMethod = async (): Promise<ISafeProtocolHooks> => {
    const hook = await (await hre.ethers.getContractFactory("MockContract")).deploy();
    await hook.givenMethodReturnBool("0x01ffc9a7", false);
    return hre.ethers.getContractAt("ISafeProtocolHooks", await hook.getAddress());
};

export const getHookWithPassingChecks = async (): Promise<ISafeProtocolHooks> => {
    const hook = await (await hre.ethers.getContractFactory("MockContract")).deploy();
    await hook.givenMethodReturnBool("0x01ffc9a7", true);
    // 0x7359b742 -> selector for preCheckRootAccess
...
export const getHookWithFailingPostCheck = async (): Promise<ISafeProtocolHooks> => {
    const hook = await (await hre.ethers.getContractFactory("MockContract")).deploy();
    await hook.givenMethodReturnBool("0x01ffc9a7", true);
    // 0x7359b742 -> selector for preCheckRootAccess
    await hook.givenMethodReturn("0x7359b742", "0x");
